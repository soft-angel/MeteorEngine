...
}else if($arGetFilter = $FIREWALL->GetArrayString($arParams['FILTER_NAME'])){
	$arFilter = $arGetFilter;
}elseif(isset($_SESSION['FILTER'][$arParams['FILTER_NAME']])){
	$arFilter = $_SESSION['FILTER'][$arParams['FILTER_NAME']];
}
//p($arParams["FILTER"]);
